A very simple mod to hide hypixel lobby join messages. Works by default with no user action necessary.

* new! now supports all languages

## Commands
/dontjoinmylobby - toggles the feature on and off
